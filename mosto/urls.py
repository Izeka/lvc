...
urlpatterns = [
    ...
    url(r'^ingredientes/nuevo/(?P<insumo>\w+)/$',
        Nuevo_insumo.as_view(), name='add_ingrediente'),
    url(r'^ingredientes/editar/(?P<pk>\d+)/$', Editar_insumo.as_view(),),

    url(r'^equipamiento/$', Equipamiento.as_view()),
    url(r'^equipamiento/nuevo/(?P<insumo>\w+)/$',
        Nuevo_insumo.as_view(), name='add_equipamiento'),
    ...
    url(r'^compras/equipamiento/(?P<equipamiento>\w+)$',
        Compra_equipamiento.as_view(), name='add_equipamiento'),
    url(r'^compras/editar/(?P<pk>\d+)$',
